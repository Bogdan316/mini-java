...
class SimpleNode implements Node {
  ...
  public final DefaultMutableTreeNode jTree;

  public SimpleNode(int i) {
    jTree = new DefaultMutableTreeNode(this.toString());
    id = i;
  }
...
/* JavaCC - OriginalChecksum=490f4e01b521269dcc23e5e4a7d8100a (do not edit this line) */
